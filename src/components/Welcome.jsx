    ...
    <div className="flex flex-col justify-center h-full pl-4 mt-24 sm:mt-32 lg:mt-24">
      <div className="flex flex-col md:flex-row items-center lg:gap-8 sm:gap-2">
        ...
        <img 
          ...
          loading="lazy" 
          className="w-52 h-52 md:w-56 md:h-56 lg:w-80 lg:h-80 2xl:ml-72 rounded-full shadow-lg transition-transform duration-500 ease-in-out transform hover:scale-110 hover:shadow-blue-500/50 object-cover" 
          itemProp="image" 
        />
      </div>
      <button
